...
extern uintptr_t fat32_load_elf(uint32_t fd, uintptr_t pgdir, uint64_t *file_length, void *initpcb ,
    uintptr_t (*prepare_page_for_va)(uintptr_t va, uintptr_t pgdir, uint64_t mode));
...
extern uintptr_t fast_load_elf(const char * filename, uintptr_t pgdir, uint64_t *file_length, void *initpcb);

extern uintptr_t fast_load_elf_execve(const char * filename, void *initpcb);
...
// ===================== for dynamic ==========================
#define DYNAMIC_VADDR_PFFSET 0x8000000
